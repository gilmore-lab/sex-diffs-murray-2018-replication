...
#    ]
conditions_simple = [
    {'label':'hi_contr', 'startVal':start_secs, 'minVal': min_secs, 'maxVal': max_secs, 'max_contr':.98,'grating_deg':grating_deg, 'stepSizes':[8,4,4,2,2,1], 'spf':spf, 'tf':tf, 'mask_type': mask_type},
    ]
